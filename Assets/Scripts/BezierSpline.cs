...
public class BezierSpline : MonoBehaviour
{
    ...
    public void EnforceMode(int index)
    {
        ...
        if(mode == BezierControlPointMode.Free || _isLoop == false && (modeIndex == 0 || modeIndex == _modes.Length - 1))
        {
            return;
        }
    ...
    {        int i;
        ...
        return transform.TransformPoint(Bezier.GetFirstDerivative(_points[i], _points[i + 1], _points[i + 2], _points[i + 3], t));
    }

    public Vector3 GetDirection (float t)
    {
        return GetVelocity(t).normalized * 3;
    }
